...
--Q1. What is the total revenue generated by males vs female customer?
select gender, SUM(purchase_amount) as revenue
from customer
group by gender

--Q2. Which customer used a discount bit still they spent more than the average purchase amount?
...
--Compare average spend and total revenue between subcribers and non-subscribers.
